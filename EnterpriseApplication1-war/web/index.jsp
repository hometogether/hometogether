                                ...
                                <div class="container-page">
                                    ...
                                    <div class="col-md-6 feature-main">
                                        ...
                                        <div class="form-group col-lg-12">
                                                ...
                                                <input type="email" name="r_email" class="form-control"  placeholder="Ripeti email">
                                        </div>
                                        ...
                                        <div class="form-group col-lg-12">
                                                <!--<label>Password</label>-->
                                                <input type="password" name="r_password" class="form-control"  placeholder="Reinserisci la password">
                                        </div>
                                        
                                        <div class="form-group col-lg-12">
                                                <!--<label>Password</label>-->
                                                <input type="password" name="località" class="form-control"  placeholder="Inserisci la tua località">
                                        </div>
